...
> $\quad$ 一次同余式组
>
> $$x\equiv b_1\ \textrm{mod}\ m_1,\ x\equiv b_2\ \textrm{mod}\ m_2 \tag{1}$$
>
...
$$m_1y \equiv b_2-b_1\ \textrm{mod}\ m_2 \tag{1.1}$$
...
$$a_kx_k+b \equiv 0\ \textrm{mod}\ d_1 \tag{2}$$

$$a_1x_1+\cdots+a_{k-1}x_{k-1} \equiv d_1\ \textrm{mod}\ m \tag{3}$$
